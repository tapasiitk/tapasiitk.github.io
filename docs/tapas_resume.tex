...
\begin{itemize}
  ...
  \item Developing \href{https://github.com/tapasiitk/situated-agency-alignment}{Situated Agency Alignment (KARMA)}, an exploratory MARL project on proxy agency, plural values, role-invariant representations, cooperation, and harmful strategic drift.
\end{itemize}
...
\sectiontight{Selected Research Code}
\begin{itemize}
  \item \textbf{Situated Agency Alignment (KARMA):} Public MARL codebase for proxy agency, plural-values alignment, commons conflict, and role-invariant representation interventions. \href{https://github.com/tapasiitk/situated-agency-alignment}{[GitHub]}
  \item \textbf{Robust Context Metrics:} Agent-based simulations testing attraction-effect measures under heterogeneous preferences. \href{https://github.com/tapasiitk/robust-context-metrics}{[GitHub]}
\end{itemize}
